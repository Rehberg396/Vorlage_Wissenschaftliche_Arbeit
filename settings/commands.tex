% --------------------------------
% Hilfszähler für römische Seitenzahlen
% --------------------------------
...
% --------------------------------
% TODO-Notation + TODO-Liste
% --------------------------------

\makeatletter
\newcommand{\todo@entries}{}
\newcounter{todocount}

\newcommand{\todo@store}[2]{%
  \stepcounter{todocount}%
  \g@addto@macro\todo@entries{\item[\textbf{S.~#1}] \textcolor{red}{#2}}%
}

\newcommand{\todo}[1]{%
  \textcolor{red}{#1}%
  \protected@write\@auxout{}{\string\todo@store{\thepage}{#1}}%
}
