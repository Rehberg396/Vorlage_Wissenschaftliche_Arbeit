...
\newcommand{\signature}[1]{
    \newline % Fügt einen Zeilenumbruch ein
    \noindent % Unterdrückt den Einzug der neuen Zeile
    \begin{tabular}{@{}ll@{}} % Beginnt eine Tabelle ohne zusätzlichen horizontalen Abstand links oder rechts
        #1, den \today & \makebox[6.5cm]{\hrulefill}\\ % Erste Zeile der Tabelle: Ort und Datum, daneben eine Linie für die Unterschrift
        & Unterschrift % Zweite Zeile der Tabelle: Das Wort "Unterschrift" unterhalb der Linie
    \end{tabular}
}
...
\newcommand{\flexFigure}[3]{
  \begin{figure}[H] % Beginnt eine Abbildung in einer Gleitumgebung mit fester Position auf der Seite
    ...
    \label{fig:#3} % Setzt ein Label für die Abbildung, das für Verweise verwendet werden kann
  \end{figure}
}
