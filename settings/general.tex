...
\usepackage[hyperref=true]{acro} % Akronyme mit Links zu ihrer Definition
...
\usepackage{xurl}           % Bessere URL-Trennung
...
\usepackage{acro}           % Verwaltung und Definition von Akronymen im Dokument
...
%\usepackage[style=iso-numeric]{biblatex} % Zitate und Literaturverzeichnis im ISO-Format
